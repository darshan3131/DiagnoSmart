...
sym_des = pd.read_csv(os.path.join(base_dir, "HealthPredict", "symtoms_df.csv"))
precautions = pd.read_csv(os.path.join(base_dir, "HealthPredict", "precautions_df.csv"))
workout = pd.read_csv(os.path.join(base_dir, "HealthPredict", "workout_df.csv"))
description = pd.read_csv(os.path.join(base_dir, "HealthPredict", "description.csv"))
medications = pd.read_csv(os.path.join(base_dir, "HealthPredict", "medications.csv"))
diets = pd.read_csv(os.path.join(base_dir, "HealthPredict", "diets.csv"))

with open(os.path.join(base_dir, "aimodels", "svc.pkl"), 'rb') as model_fileL:
